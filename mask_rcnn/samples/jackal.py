...
class JackalDataset(utils.Dataset):

    #return as list
    def load_jsons(self, folder):
        result = []
        print('load_jsons: ', folder+"/*.json")
    ...
    def load_jackal(self, dataset_dir, subset):
        ...
        for a in annotations:
            ...
            image_path = a['imagePath'] # labelme2coco generate full path for each annotation entry
...
def train(model):
    """Train the model."""
    # Training dataset.
    dataset_train = JackalDataset()
    dataset_train.load_jackal(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = JackalDataset()
    dataset_val.load_jackal(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    if args.command == "train":
        ...
        class InferenceConfig(JackalConfig):
